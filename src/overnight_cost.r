...
overnight = overnight %>%
  ...
  # We convert everything to dollars per MWh later
  # Source: http://www.eia.gov/tools/faqs/faq.cfm?id=19&t=5
  mutate(variable.o.m = variable.o.m*1000)
  # convert dollars per kWh to dollars per MWh (could be done in a single step but done this way for readability)
