...
Instead, we identify the size pf each plant using data from EIA Form 860 and merge the two data sources using the unique plant identifier.
...
Fuel price data for the period (1/1986-5/2016) is available from Energy Information Administration (EIA) sources.
